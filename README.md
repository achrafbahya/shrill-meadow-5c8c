...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/shrill-meadow-5c8c#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/shrill-meadow-5c8c
```

A live public deployment of this template is available at [https://shrill-meadow-5c8c.templates.workers.dev](https://shrill-meadow-5c8c.templates.workers.dev)
